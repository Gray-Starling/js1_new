...
function showMoreText(card) {
    ...
    let productDesc = "Lorem ipsum dolor sit amet, consectetur adipisicing elit. Consequatur, reiciendis.";
    // 6.2 внутри .product есть .productName, после него вставляем div.desc и текстом из переменной из п. 6.1
    card.productName.insertAdjacentHTML("afterend", `<div class = "desc">${productDesc}</div>`);
